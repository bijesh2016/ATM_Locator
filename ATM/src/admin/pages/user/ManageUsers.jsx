...
const ManageUsers = () => {
  ...
  const users = [
    { id: 1, name: 'Ram Kc', email: 'RamKc@gmail.com', role: 'Admin', status: 'Active' },
    { id: 2, name: 'Sita', email: 'sita@example.com', role: 'Manager', status: 'Active' },
    { id: 3, name: 'Bobby', email: 'bobby@example.com', role: 'User', status: 'Pending' },
  ];
