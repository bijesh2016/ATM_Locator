  ...
  const alerts = [
    {
      id: 1,
      severity: "high",
      message: "ATM-1245 low on cash",
      time: "30 mins ago",
    },
    {
      id: 2,
      severity: "medium",
      message: "Network connectivity issue at Main Branch",
      time: "2 hours ago",
    },
  ];
          ...
          <Col key={index} xs={12} sm={6} md={3} className="mb-3">
            <Card className={`border-0 bg-${stat.color}-light`}>
              <Card.Body className="d-flex align-items-center">
                <div
                  className={`icon-shape icon-lg bg-${stat.color} text-white rounded-circle me-3`}
                >
                  {stat.icon}
                </div>
                <div>
